...
class SwiftKernelIPCClient:
    ...
    def contract_roundtrip(self, payload: dict[str, Any]) -> dict[str, Any]:
        """Decode/re-encode contract payloads through the Swift KernelServer."""
        return self._rpc("contract_roundtrip", payload)
