...
class BehavioralControlTests(unittest.TestCase):
    ...
    def test_draft_repair_plan_normalizes_into_existing_taxonomy(self):
        normalized = normalize_intent("draft_day_repair_plan")
        self.assertEqual(normalized["intent"], "ask_clarification")
        self.assertEqual(normalized["matched_by"], "alias")
    ...
    def test_biography_update_event_provenance_and_decay(self):
        ...
        self.assertGreater(updated.notification_fatigue, self.biography.notification_fatigue)
