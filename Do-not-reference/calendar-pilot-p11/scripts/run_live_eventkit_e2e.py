...
def eventkit_probe_candidate() -> CandidateCalendarAction:
    ...
    sandbox_calendar_id = os.environ.get("CALENDAR_PILOT_SELFPLAY_EVENTKIT_SANDBOX_CALENDAR_ID") or os.environ.get("CALENDAR_PILOT_EVENTKIT_SANDBOX_CALENDAR_ID") or "default"
    return CandidateCalendarAction(
        ...
        target_calendars=[sandbox_calendar_id],
        affected_event_ids=[],
        affected_people_ids=[],
