...
def extract_signals(observation: RawCalendarObservation, biography: UserBiography) -> CalendarSignals:
    ...
    if fatigue > 0.65:
        risks.append("interruption_tolerance_low")
...
def _narrative(
    ...
    if interruption_pressure > 0.6:
        lines.append("Observed interruption tolerance is low; acting silently or bundling beats interruption.")
    return lines