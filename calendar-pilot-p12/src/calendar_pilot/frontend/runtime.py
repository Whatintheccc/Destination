...
def process_cwd() -> str:
    try:
        ...
        return os.environ.get("CALENDAR_PILOT_APP_ROOT") or str(ROOT)
    ...
    *,
    ...
    return {
        ...
        "process": {
            ...
            "port": int(os.environ["CALENDAR_PILOT_LAUNCH_PORT"]) if os.environ.get("CALENDAR_PILOT_LAUNCH_PORT", "").isdigit() else None,
