...
from evals.p13_ruler.wave import compare_b_migrate_artifacts, load_json, resolve
...
def main() -> None:
    ...
    parser.add_argument("--assertions", default="experiments/configs/b_migrate_frontend_view_state_v2.json")
    ...
    payload = compare_b_migrate_artifacts(
        before_path=before,
        after_path=after,
        assertions_path=resolve(args.assertions),
        manifest=manifest,
    )
