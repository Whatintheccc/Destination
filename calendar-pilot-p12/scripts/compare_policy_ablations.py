...
def main():
 ap=argparse.ArgumentParser(); ap.add_argument('--reports',nargs='*',default=[]); ap.add_argument('--out',default='runs/p12_policy_ablation_comparison.json'); args=ap.parse_args(); rows=[]
