...
class ActionLifecycle:
    ...
    def stage(
        ...
        *,
        ...
        self.replay.append_receipt(receipt, candidate, trace_id=trace_id, causal_parent_id=causal_parent_id, observation_id=observation.observation_id, observation_fingerprint=observation_fingerprint(observation))
    ...
    def commit(
        ...
        *,
        ...
        self.replay.append_receipt(swift_receipt, candidate, trace_id=trace_id, causal_parent_id=causal_parent_id, observation_id=observation.observation_id, observation_fingerprint=observation_fingerprint(observation))
    ...
    def verify(self, envelope: ActionEnvelope) -> ActionEnvelope:
        ...
        envelope.transition("verify", status="succeeded", detail={"rollback_state": state})
    ...
    def undo(
        ...
        *,
        ...
        self.replay.append_receipt(receipt, trace_id=trace_id, causal_parent_id=causal_parent_id, observation_id=observation.observation_id, observation_fingerprint=observation_fingerprint(observation))
