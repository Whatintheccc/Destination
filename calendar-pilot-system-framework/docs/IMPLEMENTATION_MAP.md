...
| System framework substrate | `SYSTEM_FRAMEWORK.md`, `src/calendar_pilot/environment/*`, `src/calendar_pilot/frontend/projector.py`, `docs/SYSTEM_FRAMEWORK_IMPLEMENTATION_PASS.md` |
