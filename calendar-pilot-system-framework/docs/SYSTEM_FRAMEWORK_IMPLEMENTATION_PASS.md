...
This pass implements the first practical slice of `SYSTEM_FRAMEWORK.md`: evidence integrity, canonical learning keys, replay visibility, and the object-substrate seams. It intentionally does not complete the Glass Cockpit frontend or full ActionLifecycle extraction; it creates the spine those phases can attach to without blocking recommendation dogfooding.
