...
class CodexToolRuntime:
    ...
    def _execute_inner(
        ...
        if name == CodexToolName.REQUEST_UNDO:
            ...
            status = CodexToolStatus.DENIED if output.denied_reason else CodexToolStatus.REVERTED
            ...
            return self._receipt(
                ...
                status,
                {
                    ...
                    "rollback_verified": provider_rollback.rollback_verified if provider_rollback is not None else None,
                },
