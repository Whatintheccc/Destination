...
class LaunchConfig:
    ...
    def from_env(
        ...
        *,
        ...
        selected_runtime = (runtime_mode or os.environ.get("CALENDAR_PILOT_RUNTIME_MODE", "fixture")).strip().lower().replace("-", "_")
    ...
    def write_manifest(self) -> Path:
        ...
        self.manifest_path.write_text(json.dumps(self.to_dict(), indent=2, sort_keys=True), encoding="utf-8")
